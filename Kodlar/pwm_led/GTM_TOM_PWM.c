...
#define LED2                 IfxGtm_TOM0_2_TOUT107_P10_5_OUT         /* LED which will be driven by the PWM          */
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.tom = LED2.tom;                                      /* Select the TOM depending on the LED          */
    ...
    g_tomConfig.pin.outputPin = &LED2;                               /* Set the LED port pin as output               */
