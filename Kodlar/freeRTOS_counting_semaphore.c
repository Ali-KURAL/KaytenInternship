...
/* Definitions for led_toggled */
osSemaphoreId_t led_toggledHandle;
const osSemaphoreAttr_t led_toggled_attributes = {
  .name = "led_toggled"
};
/* USER CODE BEGIN PV */
...
void led2_task_func(void *argument);
void button_task_func(void *argument);
void led3_task_func(void *argument);
...
int main(void)
{
  ...
  /* creation of led_toggled */
  led_toggledHandle = osSemaphoreNew(3, 3, &led_toggled_attributes);
  ...
  led2_taskHandle = osThreadNew(led2_task_func, NULL, &led2_task_attributes);

  /* creation of button_task */
  button_taskHandle = osThreadNew(button_task_func, NULL, &button_task_attributes);

  /* creation of led3_task */
  led3_taskHandle = osThreadNew(led3_task_func, NULL, &led3_task_attributes);
...
/* USER CODE BEGIN Header_led2_task_func */
/**
* @brief Function implementing the led2_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_led2_task_func */
void led2_task_func(void *argument)
{
  /* USER CODE BEGIN led2_task_func */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END led2_task_func */
}

/* USER CODE BEGIN Header_button_task_func */
/**
* @brief Function implementing the button_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_button_task_func */
void button_task_func(void *argument)
{
  /* USER CODE BEGIN button_task_func */
	int8_t led_state = 0;
  ...
  for(;;)
  {
		if(HAL_GPIO_ReadPin(B1_GPIO_Port,B1_Pin) && !pressed)
		{
		  ...
		  for (int i = 0;i < led_state;i++) osSemaphoreAcquire(led_toggledHandle,1);
  ...
  /* USER CODE END button_task_func */
}

/* USER CODE BEGIN Header_led3_task_func */
/**
* @brief Function implementing the led3_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_led3_task_func */
void led3_task_func(void *argument)
{
  /* USER CODE BEGIN led3_task_func */
  /* Infinite loop */
  for(;;)
  {
		osSemaphoreAcquire(led_toggledHandle,portMAX_DELAY);
		HAL_GPIO_WritePin(GPIOA,GPIO_PIN_0,GPIO_PIN_SET);
		osDelay(500)
		HAL_GPIO_WritePin(GPIOA,GPIO_PIN_0,GPIO_PIN_SET);
    osDelay(1);
  }
  /* USER CODE END led3_task_func */
}
