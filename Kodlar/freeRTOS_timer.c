...
void timer1_callback_func(void *argument);
...
int main(void)
{
  ...
  /* Create the timer(s) */
  /* creation of timer1 */
  timer1Handle = osTimerNew(timer1_callback_func, osTimerPeriodic, NULL, &timer1_attributes);
...
/* timer1_callback_func function */
void timer1_callback_func(void *argument)
{
  /* USER CODE BEGIN timer1_callback_func */
	HAL_GPIO_TogglePin(GPIOA,GPIO_PIN_5);
  /* USER CODE END timer1_callback_func */
}
